#!/bin/bash
#
# Start-Stop-Hooks for component ComponentUUVSonar
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentUUVSonar.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentUUVSonar.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentUUVSonar.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentUUVSonar.sh post-stop
