#!/bin/bash
#
# Start-Stop-Hooks for component ComponentRosJoystick
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentRosJoystick.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentRosJoystick.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentRosJoystick.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentRosJoystick.sh post-stop
