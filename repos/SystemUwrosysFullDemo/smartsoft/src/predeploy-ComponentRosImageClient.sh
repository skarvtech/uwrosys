#!/bin/bash
#
# This script is run prior to deployment of component ComponentRosImageClient
...
source $REFERENCED_PROJECT_ComponentRosImageClient/smartsoft/src/predeploy.sh
