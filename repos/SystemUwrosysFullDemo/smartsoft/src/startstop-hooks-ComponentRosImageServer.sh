#!/bin/bash
#
# Start-Stop-Hooks for component ComponentRosImageServer
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentRosImageServer.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentRosImageServer.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentRosImageServer.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentRosImageServer.sh post-stop
