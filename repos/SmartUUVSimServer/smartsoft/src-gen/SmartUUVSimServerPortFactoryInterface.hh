...
#ifndef SMARTUUVSIMSERVER_PORTFACTORYINTERFACE_HH_
#define SMARTUUVSIMSERVER_PORTFACTORYINTERFACE_HH_
...
// forward declaration
class SmartUUVSimServer;

class SmartUUVSimServerPortFactoryInterface {
public:
	SmartUUVSimServerPortFactoryInterface() { };
	virtual ~SmartUUVSimServerPortFactoryInterface() { };

	virtual void initialize(SmartUUVSimServer *component, int argc, char* argv[]) = 0;
...
#endif /* SMARTUUVSIMSERVER_PORTFACTORYINTERFACE_HH_ */
