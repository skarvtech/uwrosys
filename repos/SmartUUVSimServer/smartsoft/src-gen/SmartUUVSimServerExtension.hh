...
#ifndef SMARTUUVSIMSERVER_EXTENSION_HH_
#define SMARTUUVSIMSERVER_EXTENSION_HH_
...
public:
	SmartUUVSimServerExtension(const std::string &name);
	virtual ~SmartUUVSimServerExtension();
...
#endif /* SMARTUUVSIMSERVER_EXTENSION_HH_ */
