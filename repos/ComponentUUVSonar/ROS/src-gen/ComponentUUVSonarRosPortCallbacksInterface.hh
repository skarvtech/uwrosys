...
class ComponentUUVSonarRosPortCallbacksInterface {
public:
	ComponentUUVSonarRosPortCallbacksInterface() { };
	virtual ~ComponentUUVSonarRosPortCallbacksInterface() { }
	
	virtual void _sonar_cb (const sensor_msgs::LaserScan::ConstPtr &msg) = 0;
