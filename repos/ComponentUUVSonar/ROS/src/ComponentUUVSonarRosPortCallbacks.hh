...
#include "ComponentUUVSonarRosPortCallbacksInterface.hh"

class ComponentUUVSonarRosPortCallbacks : public ComponentUUVSonarRosPortCallbacksInterface {
public:
	ComponentUUVSonarRosPortCallbacks();
	virtual ~ComponentUUVSonarRosPortCallbacks();
	
	virtual void _sonar_cb (const sensor_msgs::LaserScan::ConstPtr &msg) override;
