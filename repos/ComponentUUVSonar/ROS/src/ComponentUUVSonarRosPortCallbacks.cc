...
ComponentUUVSonarRosPortCallbacks::ComponentUUVSonarRosPortCallbacks() {  }

ComponentUUVSonarRosPortCallbacks::~ComponentUUVSonarRosPortCallbacks() {  }

void ComponentUUVSonarRosPortCallbacks::_sonar_cb (const sensor_msgs::LaserScan::ConstPtr &msg)
{
	// for implementing this method, you can use the "COMP->" macro to access the component's class members
	COMP->sonarTask->_sonar_cb(msg);
