...
#ifndef COMPONENTUUVMANIPULATOR_EXTENSION_HH_
#define COMPONENTUUVMANIPULATOR_EXTENSION_HH_
...
public:
	ComponentUUVManipulatorExtension(const std::string &name);
	virtual ~ComponentUUVManipulatorExtension();
...
#endif /* COMPONENTUUVMANIPULATOR_EXTENSION_HH_ */
