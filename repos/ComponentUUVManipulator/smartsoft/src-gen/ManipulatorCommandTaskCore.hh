...
//--------------------------------------------------------------------------
#ifndef _MANIPULATORCOMMANDTASK_CORE_HH
#define _MANIPULATORCOMMANDTASK_CORE_HH
...
private:
	...
	std::list<ManipulatorCommandTaskObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(ManipulatorCommandTaskObserverInterface *observer);
	void detach_interaction_observer(ManipulatorCommandTaskObserverInterface *observer);

public:
	ManipulatorCommandTaskCore(Smart::IComponent *comp, const bool &useDefaultState=true);
	virtual ~ManipulatorCommandTaskCore();
