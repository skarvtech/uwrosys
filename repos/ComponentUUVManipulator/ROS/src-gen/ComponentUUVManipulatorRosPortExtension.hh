...
class ComponentUUVManipulatorRosPortExtension : public ComponentUUVManipulatorExtension, public ComponentUUVManipulatorRosPortBaseClass
{
private:
	ros::NodeHandle *nh;
...
public:
	...
	virtual ~ComponentUUVManipulatorRosPortExtension();
