...
#include "ComponentRosImageServerRosPortCallbacksInterface.hh"

class ComponentRosImageServerRosPortCallbacks : public ComponentRosImageServerRosPortCallbacksInterface {
public:
	ComponentRosImageServerRosPortCallbacks();
	virtual ~ComponentRosImageServerRosPortCallbacks();
	
	virtual void _camera_image_cb (const sensor_msgs::Image::ConstPtr &msg) override;
