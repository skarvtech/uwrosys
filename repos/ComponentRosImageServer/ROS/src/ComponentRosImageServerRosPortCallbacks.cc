...
ComponentRosImageServerRosPortCallbacks::ComponentRosImageServerRosPortCallbacks() {  }

ComponentRosImageServerRosPortCallbacks::~ComponentRosImageServerRosPortCallbacks() {  }

void ComponentRosImageServerRosPortCallbacks::_camera_image_cb (const sensor_msgs::Image::ConstPtr &msg)
{
	// for implementing this method, you can use the "COMP->" macro to access the component's class members
	COMP->imageTask->_camera_image_cb(msg);
}
