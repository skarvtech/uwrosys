...
class ComponentRosImageServerRosPortCallbacksInterface {
public:
	ComponentRosImageServerRosPortCallbacksInterface() { };
	virtual ~ComponentRosImageServerRosPortCallbacksInterface() { }
	
	virtual void _camera_image_cb (const sensor_msgs::Image::ConstPtr &msg) = 0;
