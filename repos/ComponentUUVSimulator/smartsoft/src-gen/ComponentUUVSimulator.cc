...
ComponentUUVSimulator* ComponentUUVSimulator::_componentUUVSimulator = 0;

// constructor
ComponentUUVSimulator::ComponentUUVSimulator()
{
	std::cout << "constructor of ComponentUUVSimulator\n";
	...
	connections.component.name = "ComponentUUVSimulator";
	...
	connections.baseStateTask.periodicActFreq = 10.0;
	...
	// initialize members of PlainOpcUaComponentUUVSimulatorExtension
	
}

void ComponentUUVSimulator::addPortFactory(const std::string &name, ComponentUUVSimulatorPortFactoryInterface *portFactory)
{
	portFactoryRegistry[name] = portFactory;
}

void ComponentUUVSimulator::addExtension(ComponentUUVSimulatorExtension *extension)
{
	componentExtensionRegistry[extension->getName()] = extension;
}

SmartACE::SmartComponent* ComponentUUVSimulator::getComponentImpl()
{
	return dynamic_cast<ComponentUUVSimulatorAcePortFactory*>(portFactoryRegistry["ACE_SmartSoft"])->getComponentImpl();
}
 ...
 */
void ComponentUUVSimulator::setStartupFinished() {
 ...
 */
Smart::StatusCode ComponentUUVSimulator::connectAndStartAllServices() {
 ...
 */
void ComponentUUVSimulator::startAllTasks() {
 ...
 */
void ComponentUUVSimulator::startAllTimers() {
}
...
void ComponentUUVSimulator::init(int argc, char *argv[])
{
	try {
		...
		// initializations of ComponentUUVSimulatorROSExtension
		
		// initializations of OpcUaBackendComponentGeneratorExtension
		
		// initializations of PlainOpcUaComponentUUVSimulatorExtension
		...
		ComponentUUVSimulatorPortFactoryInterface *acePortFactory = portFactoryRegistry["ACE_SmartSoft"];
		if(acePortFactory == 0) {
		...
		SmartACE::SmartComponent *component = dynamic_cast<ComponentUUVSimulatorAcePortFactory*>(acePortFactory)->getComponentImpl();
		
		std::cout << "ComponentDefinition ComponentUUVSimulator is named " << connections.component.name << std::endl;
...
// run the component
void ComponentUUVSimulator::run()
{
...
void ComponentUUVSimulator::fini()
{
	...
	// destruction of ComponentUUVSimulatorROSExtension
	
	// destruction of OpcUaBackendComponentGeneratorExtension
	
	// destruction of PlainOpcUaComponentUUVSimulatorExtension
	
}

void ComponentUUVSimulator::loadParameter(int argc, char *argv[])
{
	/*
	...
	try
	{
		...
		} else if(parameter.searchFile("ComponentUUVSimulator.ini", parameterfile)) {
			parameterFileFound = true;
			std::cout << "load ComponentUUVSimulator.ini parameter file\n";
			parameter.addFile(parameterfile);
		} else {
			std::cout << "WARNING: ComponentUUVSimulator.ini parameter file not found! (using default values or command line arguments)\n";
		}
		...
		// load parameters for PlainOpcUaComponentUUVSimulatorExtension
