...
#ifndef COMPONENTUUVSIMULATOR_EXTENSION_HH_
#define COMPONENTUUVSIMULATOR_EXTENSION_HH_
...
public:
	ComponentUUVSimulatorExtension(const std::string &name);
	virtual ~ComponentUUVSimulatorExtension();
...
#endif /* COMPONENTUUVSIMULATOR_EXTENSION_HH_ */
