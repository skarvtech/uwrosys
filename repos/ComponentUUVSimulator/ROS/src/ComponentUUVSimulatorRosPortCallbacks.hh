...
#include "ComponentUUVSimulatorRosPortCallbacksInterface.hh"

class ComponentUUVSimulatorRosPortCallbacks : public ComponentUUVSimulatorRosPortCallbacksInterface {
public:
	ComponentUUVSimulatorRosPortCallbacks();
