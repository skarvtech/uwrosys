...
public:
	ComponentUUVSimulatorRosPortCallbacksInterface() { };
	virtual ~ComponentUUVSimulatorRosPortCallbacksInterface() { }
	
	virtual void _pose_cb (const nav_msgs::Odometry::ConstPtr &msg) = 0;
