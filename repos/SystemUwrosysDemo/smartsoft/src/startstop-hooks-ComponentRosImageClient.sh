#!/bin/bash
#
# Start-Stop-Hooks for component ComponentRosImageClient
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentRosImageClient.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentRosImageClient.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentRosImageClient.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentRosImageClient.sh post-stop
