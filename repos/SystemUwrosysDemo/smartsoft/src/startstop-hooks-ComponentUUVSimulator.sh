#!/bin/bash
#
# Start-Stop-Hooks for component ComponentUUVSimulator
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentUUVSimulator.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentUUVSimulator.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentUUVSimulator.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentUUVSimulator.sh post-stop
