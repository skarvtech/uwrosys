#!/bin/bash
#
# This script is run prior to deployment of component ComponentRosImageServer
...
source $REFERENCED_PROJECT_ComponentRosImageServer/smartsoft/src/predeploy.sh
