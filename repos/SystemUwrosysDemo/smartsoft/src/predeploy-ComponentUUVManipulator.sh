#!/bin/bash
#
# This script is run prior to deployment of component ComponentUUVManipulator
...
source $REFERENCED_PROJECT_ComponentUUVManipulator/smartsoft/src/predeploy.sh
