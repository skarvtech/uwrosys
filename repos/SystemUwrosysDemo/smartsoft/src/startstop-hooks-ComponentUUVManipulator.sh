#!/bin/bash
#
# Start-Stop-Hooks for component ComponentUUVManipulator
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentUUVManipulator.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentUUVManipulator.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentUUVManipulator.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentUUVManipulator.sh post-stop
